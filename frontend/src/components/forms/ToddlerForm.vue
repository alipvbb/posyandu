...
const addChildToFamily = async () => {
  ...
  try {
    ...
    const updated = await familiesService.update(family.id, {
      ...
      rwId: family.rwId,
      rtId: family.rtId,
      domicileProvinceCode: family.domicileProvinceCode || null,
      domicileProvinceName: family.domicileProvinceName || null,
      domicileRegencyCode: family.domicileRegencyCode || null,
      domicileRegencyName: family.domicileRegencyName || null,
      domicileDistrictCode: family.domicileDistrictCode || null,

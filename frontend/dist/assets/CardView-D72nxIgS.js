import{d as S,o as u,c,b as a,t as s,l as C,a as T,p as D,f as l,w as f,g as j,m as v,j as n,e as k,A as N,J as U}from"./index-BOnb9_d2.js";import{_ as V}from"./AppButton.vue_vue_type_script_setup_true_lang-BqGiRphN.js";import{A as w}from"./AppCard-D1STXvM8.js";import{_ as I}from"./AppLoadingBlock.vue_vue_type_script_setup_true_lang-DgpWR8SN.js";import{t as P}from"./toddlers.service-DS3Fvpcr.js";import{f as _,g as z}from"./format-VdMr5c1N.js";const R={class:"qr-card"},B=["src"],Q={key:0},E=S({__name:"QrCodeCardPreview",props:{image:{},value:{},title:{},showValue:{type:Boolean}},setup(o){return(b,x)=>(u(),c("div",R,[a("strong",null,s(o.title||"QR Kartu Posyandu"),1),a("img",{src:o.image,alt:"QR Code Posyandu",class:"qr-image"},null,8,B),o.showValue!==!1?(u(),c("small",Q,s(o.value),1)):C("",!0)]))}}),J={key:0,class:"form-grid"},M={key:1,class:"form-grid"},F={key:2,class:"form-grid"},L={class:"page-head"},O={class:"print-card card-print-sheet idcard-preview"},G={class:"idcard-preview-head"},H={class:"idcard-preview-brand"},W={class:"muted-text"},Y={class:"idcard-preview-number"},X={class:"status-badge","data-tone":"green"},Z={class:"idcard-preview-body"},aa={class:"form-grid"},ea={style:{margin:"0"}},ta={class:"muted-text",style:{margin:"0"}},ia={class:"idcard-preview-meta"},ma=S({__name:"CardView",setup(o){const b=j(),x=T(),t=v(null),m=v(null),h=v(!0),y=v(!1),i=r=>String(r??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),K=()=>{var $,A;if(!t.value||!m.value)return;const r=t.value.toddler,e=_(r.tanggal_lahir),p=z(r.jenis_kelamin),g=_(t.value.updatedAt||t.value.createdAt||new Date().toISOString()),q=`<!doctype html>
<html lang="id">
  <head>
    <meta charset="UTF-8" />

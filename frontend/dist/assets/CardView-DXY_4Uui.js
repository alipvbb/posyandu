import{d as q,i as u,c as p,b as a,t as s,l as C,a as U,q as V,f as l,w as f,g as j,n as v,k as d,e as b,A as N,L as B}from"./index-BNCPmSSA.js";import{_ as I}from"./AppButton.vue_vue_type_script_setup_true_lang-uGuvJ_zT.js";import{A as w}from"./AppCard-BdR_8ZmR.js";import{_ as R}from"./AppLoadingBlock.vue_vue_type_script_setup_true_lang-D_uxfVyr.js";import{t as P}from"./toddlers.service-kTYycjYz.js";import{f as _,a as z,g as S}from"./format-D6_TRnpA.js";const Q={class:"qr-card"},E=["src"],F={key:0},L=q({__name:"QrCodeCardPreview",props:{image:{},value:{},title:{},showValue:{type:Boolean}},setup(o){return(h,x)=>(u(),p("div",Q,[a("strong",null,s(o.title||"QR Kartu Posyandu"),1),a("img",{src:o.image,alt:"QR Code Posyandu",class:"qr-image"},null,8,E),o.showValue!==!1?(u(),p("small",F,s(o.value),1)):C("",!0)]))}}),M={key:0,class:"form-grid"},J={key:1,class:"form-grid"},O={key:2,class:"form-grid"},G={class:"page-head"},H={class:"print-card card-print-sheet idcard-preview"},W={class:"idcard-preview-head"},Y={class:"idcard-preview-brand"},X={class:"muted-text"},Z={class:"idcard-preview-number"},aa={class:"status-badge","data-tone":"green"},ea={class:"idcard-preview-body"},ta={class:"form-grid"},ia={style:{margin:"0"}},ra={class:"muted-text",style:{margin:"0"}},sa={class:"idcard-preview-meta"},pa=q({__name:"CardView",setup(o){const h=j(),x=U(),t=v(null),m=v(null),y=v(!0),k=v(!1),i=r=>String(r??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"),K=()=>{var $,A;if(!t.value||!m.value)return;const r=t.value.toddler,e=_(r.tanggal_lahir),c=z(r.tanggal_lahir),g=S(r.jenis_kelamin),T=_(t.value.updatedAt||t.value.createdAt||new Date().toISOString()),D=`<!doctype html>
<html lang="id">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="sheet">
      <section class="id-card">
          ...
          <div class="identity">
            ...
            <div class="meta-box">
              <div class="meta-grid">
                ...
                <div class="meta-row"><span>Umur</span><b>${i(c)}</b></div>
                <div class="meta-row"><span>Jenis Kelamin</span><b>${i(g)}</b></div>
        ...
        <footer class="footer">
          <div>Diterbitkan: ${i(T)} • Jika kartu hilang, hubungi petugas desa untuk cetak ulang.</div>
          <div>${i(B)}</div>
        </footer>
      </section>
    </div>
  </body>
</html>`,n=window.open("","_blank","noopener,noreferrer");if(!n){window.print();return}n.document.open(),n.document.write(D),n.document.close(),n.focus(),window.setTimeout(()=>{n.print(),n.close()},300)};return V(async()=>{y.value=!0,k.value=!1;try{const[r,e]=await Promise.all([P.getCard(String(h.params.id)),P.getQr(String(h.params.id))]);t.value=r,m.value=e}catch{k.value=!0,x.pushToast("Gagal memuat kartu posyandu.","error")}finally{y.value=!1}}),(r,e)=>y.value?(u(),p("div",M,[l(w,null,{default:f(()=>[l(R,{text:"Memuat kartu posyandu..."})]),_:1})])):k.value?(u(),p("div",J,[l(w,null,{default:f(()=>[...e[0]||(e[0]=[a("div",{class:"empty-state"},"Kartu posyandu gagal dimuat. Coba refresh halaman.",-1)])]),_:1})])):t.value&&m.value?(u(),p("div",O,[a("div",G,[e[2]||(e[2]=a("div",null,[a("h2",{style:{margin:"0"}},"Kartu Posyandu"),a("p",{class:"muted-text",style:{margin:"6px 0 0"}},"Versi printable dengan QR unik untuk petugas dan akses publik orang tua.")],-1)),l(I,{onClick:K},{default:f(()=>[...e[1]||(e[1]=[d("Cetak kartu",-1)])]),_:1})]),l(w,{class:"card-print-panel"},{default:f(()=>{var c,g;return[a("div",H,[a("div",W,[a("div",Y,[e[4]||(e[4]=a("div",{class:"idcard-preview-mark"},"PA",-1)),a("div",null,[a("small",X,s(b(N)),1),e[3]||(e[3]=a("h3",null,"Kartu Identitas Posyandu",-1))])]),a("div",Z,[e[5]||(e[5]=a("small",{class:"muted-text"},"Nomor Kartu",-1)),a("div",aa,s(t.value.cardNumber),1)])]),a("div",ea,[a("div",ta,[e[13]||(e[13]=a("small",{class:"muted-text"},"Nama Balita",-1)),a("h3",ia,s(t.value.toddler.nama_lengkap),1),a("p",ra,s(t.value.toddler.kode_balita),1),a("div",sa,[a("div",null,[e[6]||(e[6]=d("TTL: ",-1)),a("strong",null,s(b(_)(t.value.toddler.tanggal_lahir)),1)]),a("div",null,[e[7]||(e[7]=d("Umur: ",-1)),a("strong",null,s(b(z)(t.value.toddler.tanggal_lahir)),1)]),a("div",null,[e[8]||(e[8]=d("JK: ",-1)),a("strong",null,s(b(S)(t.value.toddler.jenis_kelamin)),1)]),a("div",null,[e[9]||(e[9]=d("Ibu: ",-1)),a("strong",null,s(t.value.toddler.nama_ibu),1)]),a("div",null,[e[10]||(e[10]=d("Ayah: ",-1)),a("strong",null,s(t.value.toddler.nama_ayah||"-"),1)]),a("div",null,[e[11]||(e[11]=d("Posyandu: ",-1)),a("strong",null,s((c=t.value.toddler.posyandu)==null?void 0:c.name),1)]),a("div",null,[e[12]||(e[12]=d("Dusun: ",-1)),a("strong",null,s((g=t.value.toddler.hamlet)==null?void 0:g.name),1)])])]),l(L,{image:m.value.dataUrl,value:t.value.publicUrl,"show-value":!1,title:"Scan data tumbuh kembang"},null,8,["image","value"])]),e[14]||(e[14]=a("small",{class:"muted-text"},"Format cetak: A5 landscape, proporsional untuk kartu identitas posyandu.",-1))])]}),_:1})])):C("",!0)}});export{pa as default};
